import cohere #Importing the cohere library for AI model interaction
from rich import print #Importing the rich library to enhance terminal outputs
...
#define a list of recognized funtions keywords for task categorization.
funcs = [
...
ChatHistory = [
    ...
    {"role": "Chatbot","message": " general what is today's date, reminder 11:00pm %th aug dancing performance"},
...
def FirstLayerDMM(prompt: str = "test"):
    ...
    for event in stream:
       if event.event_type == "text-generation":
            response += event.text # Append the generated text to the response string.

    #Remove newline characters and split responses from each task
...
if __name__ == "__main__":
    ...
    while True:
        print(FirstLayerDMM(input(">>> "))) # Print the response from the FirstLayerDMM function.