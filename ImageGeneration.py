...
# Function to open and display images based on a given sprompt
...
# Async function to send a query to ther Hugging Face API
...
def GenerateImages(prompt:str):
    asyncio.run(generate_images(prompt)) # Run th async image genration
    open_image(prompt) # Open the genrated images

# Main loop to mionitor for image genration requests
while True:
    ...
    try:
        ...
        if Status == "True":
            ...
            # Reset the atsuts in the file after genrating images
