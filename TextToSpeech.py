import pygame # Import pygame libarary for handling audio playback
import random # Import random for gerating random choices
import asyncio # Import asyncio for asynchronus operations
import edge_tts # Import edge_tts for text-to-speech functionlity 
...
# Asynchromous function to convert text to an audio file
...
def TTS(Text, func=lambda r=None: True ):
    while True:
        try:
            ...
            return True #Returm True if the audio played succesfully
...
# Funtion to manage Text-to-Speech with additional responses for long text
def TextToSpeech(Text,func=lambda r=None: True):
    Data = str(Text).split(".") #Split the text by periods into a list of sentences

    # List of predeined responses for cases where the text is too long
    responses = [
